...
| **ADR-20** | Provenance Validator Reconciliation (evidence-vocabulary drift, p-ancestor over-validation, unbuilt supersession view) | Accepted (operator 2026-08-24; D-A1 + D-B3 landed, D-B1 unbuilt) | Verified (defects reproduced then fixed; 267 tests; hook lands claims end-to-end) / Specified (D-B1 unimplemented) | Medium (System; Substrate reading recorded as dissent, ratify at gate) | 2026-08-23 | `ADR-20-provenance-validator-reconciliation.md` |
