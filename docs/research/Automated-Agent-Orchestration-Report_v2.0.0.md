...
| KERI/Signify | **Verified** (GLEIF vLEI production) | **Aspirational** (bridge zome designed, not built) |
| hREA/ValueFlows | **Verified** (reference implementations) | **Aspirational** (DICE attribution not built) |
