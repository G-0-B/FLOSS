...
| Coordination room | `FLOSS/packages/coordination_room/` + `flossiullk-coordination-room` MCP (`127.0.0.1:7334`) | Local | workspace `.agent-surface/rooms/default/events.jsonl` | `docs/specs/coordination-room.spec.md` — file-claim router; started by `start_mcp_daemons.ps1` |
